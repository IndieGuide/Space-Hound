...
state_bool[enum_player_state.MOVE		] = [false,	true,	false,		true,	true,	true,	true,	true,	true,		true,		false,	false,	true];
...
state_bool[enum_player_state.SQUART		] = [false,	false,	false,		true,	false,	false,	false,	true,	false,		false,		false,	false,	true];
...
state_bool[enum_player_state.CLIMB_RIGHT] = [false,	true,	false,		true,	false,	false,	false,	false,	false,		false,		false,	false,	false];
state_bool[enum_player_state.CLIMB_LEFT	] = [false,	true,	false,		true,	false,	false,	false,	false,	false,		false,		false,	false,	false];
state_bool[enum_player_state.CLIMBED	] = [false,	false,	false,		false,	false,	false,	false,	false,	false,		false,		false,	false,	false];
state_bool[enum_player_state.STAND		] = [true,	true,	false,		true,	true,	true,	true,	true,	true,		true,		true,	false,	true];
