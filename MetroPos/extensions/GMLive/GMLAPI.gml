...
#define __lnc__f1603
/// __lnc__f1603(...args2:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1604
/// __lnc__f1604()->dynamic
if (live_enabled) {
	return fps;
} else return undefined;

#define __lnc__f1605
/// __lnc__f1605()->dynamic
if (live_enabled) {
	return fps_real;
} else return undefined;

#define __lnc__f1606
/// __lnc__f1606()->dynamic
if (live_enabled) {
	return current_time;
} else return undefined;

#define __lnc__f1607
/// __lnc__f1607()->dynamic
if (live_enabled) {
	return current_year;
} else return undefined;

#define __lnc__f1608
/// __lnc__f1608()->dynamic
if (live_enabled) {
	return current_month;
} else return undefined;

#define __lnc__f1609
/// __lnc__f1609()->dynamic
if (live_enabled) {
	return current_day;
} else return undefined;

#define __lnc__f1610
/// __lnc__f1610()->dynamic
if (live_enabled) {
	return current_weekday;
} else return undefined;

#define __lnc__f1611
/// __lnc__f1611()->dynamic
if (live_enabled) {
	return current_hour;
} else return undefined;

#define __lnc__f1612
/// __lnc__f1612()->dynamic
if (live_enabled) {
	return current_minute;
} else return undefined;

#define __lnc__f1613
/// __lnc__f1613()->dynamic
if (live_enabled) {
	return current_second;
} else return undefined;

#define __lnc__f1614
/// __lnc__f1614()->dynamic
if (live_enabled) {
	return room;
} else return undefined;

#define __lnc__f1615
/// __lnc__f1615()->dynamic
if (live_enabled) {
	return room_first;
} else return undefined;

#define __lnc__f1616
/// __lnc__f1616()->dynamic
if (live_enabled) {
	return room_last;
} else return undefined;

#define __lnc__f1617
/// __lnc__f1617()->dynamic
if (live_enabled) {
	return room_width;
} else return undefined;

#define __lnc__f1618
/// __lnc__f1618()->dynamic
if (live_enabled) {
	return room_height;
} else return undefined;

#define __lnc__f1619
/// __lnc__f1619(...args3:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1620
/// __lnc__f1620(...args4:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
		score = argument[1];
		return undefined;
...
#define __lnc__f1621
/// __lnc__f1621(...args5:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
		lives = argument[1];
		return undefined;
...
#define __lnc__f1622
/// __lnc__f1622(...args6:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
		health = argument[1];
		return undefined;
...
#define __lnc__f1623
/// __lnc__f1623()->dynamic
if (live_enabled) {
	return event_type;
} else return undefined;

#define __lnc__f1624
/// __lnc__f1624()->dynamic
if (live_enabled) {
	return event_number;
} else return undefined;

#define __lnc__f1625
/// __lnc__f1625()->dynamic
if (live_enabled) {
	return event_object;
} else return undefined;

#define __lnc__f1626
/// __lnc__f1626()->dynamic
if (live_enabled) {
	return event_action;
} else return undefined;

#define __lnc__f1627
/// __lnc__f1627()->dynamic
if (live_enabled) {
	return application_surface;
} else return undefined;

#define __lnc__f1628
/// __lnc__f1628()->dynamic
if (live_enabled) {
	return debug_mode;
} else return undefined;

#define __lnc__f1629
/// __lnc__f1629(...args7:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1630
/// __lnc__f1630(...args8:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1631
/// __lnc__f1631(...args9:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1632
/// __lnc__f1632(...args10:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1633
/// __lnc__f1633(...args11:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1634
/// __lnc__f1634()->dynamic
if (live_enabled) {
	return mouse_x;
} else return undefined;

#define __lnc__f1635
/// __lnc__f1635()->dynamic
if (live_enabled) {
	return mouse_y;
} else return undefined;

#define __lnc__f1636
/// __lnc__f1636(...args12:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1637
/// __lnc__f1637(...args13:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1638
/// __lnc__f1638(...args14:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1639
/// __lnc__f1639(...args15:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1640
/// __lnc__f1640(...args16:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1641
/// __lnc__f1641(...args17:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1642
/// __lnc__f1642(...args18:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1643
/// __lnc__f1643(...args19:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
...
#define __lnc__f1644
/// __lnc__f1644()->dynamic
if (live_enabled) {
	return view_current;
} else return undefined;

#define __lnc__f1645
/// __lnc__f1645(...args20:dynamic)->dynamic
if (live_enabled) {
...
#define __lnc__f1646
/// __lnc__f1646(...args21:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1647
/// __lnc__f1647(...args22:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1648
/// __lnc__f1648(...args23:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1649
/// __lnc__f1649(...args24:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1650
/// __lnc__f1650(...args25:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1651
/// __lnc__f1651(...args26:dynamic)->dynamic
if (live_enabled) {
	if(argument[2]<0||argument[2]>7)return gml_thread_error(("Index ("+string(argument[2])+") is out of range [0..7]"));
	if(argument[0]){
...
#define __lnc__f1652
/// __lnc__f1652()->dynamic
if (live_enabled) {
	return game_id;
} else return undefined;

#define __lnc__f1653
/// __lnc__f1653()->dynamic
if (live_enabled) {
	return game_display_name;
} else return undefined;

#define __lnc__f1654
/// __lnc__f1654()->dynamic
if (live_enabled) {
	return game_project_name;
} else return undefined;

#define __lnc__f1655
/// __lnc__f1655()->dynamic
if (live_enabled) {
	return game_save_id;
} else return undefined;

#define __lnc__f1656
/// __lnc__f1656()->dynamic
if (live_enabled) {
	return working_directory;
} else return undefined;

#define __lnc__f1657
/// __lnc__f1657()->dynamic
if (live_enabled) {
	return temp_directory;
} else return undefined;

#define __lnc__f1658
/// __lnc__f1658()->dynamic
if (live_enabled) {
	return program_directory;
} else return undefined;

#define __lnc__f1659
/// __lnc__f1659()->dynamic
if (live_enabled) {
	return browser_width;
} else return undefined;

#define __lnc__f1660
/// __lnc__f1660()->dynamic
if (live_enabled) {
	return browser_height;
} else return undefined;

#define __lnc__f1661
/// __lnc__f1661()->dynamic
if (live_enabled) {
	return os_type;
} else return undefined;

#define __lnc__f1662
/// __lnc__f1662()->dynamic
if (live_enabled) {
	return os_device;
} else return undefined;

#define __lnc__f1663
/// __lnc__f1663()->dynamic
if (live_enabled) {
	return os_browser;
} else return undefined;

#define __lnc__f1664
/// __lnc__f1664()->dynamic
if (live_enabled) {
	return os_version;
} else return undefined;

#define __lnc__f1665
/// __lnc__f1665()->dynamic
if (live_enabled) {
	return display_aa;
} else return undefined;

#define __lnc__f1666
/// __lnc__f1666()->dynamic
if (live_enabled) {
	return async_load;
} else return undefined;

#define __lnc__f1667
/// __lnc__f1667()->dynamic
if (live_enabled) {
	return delta_time;
} else return undefined;

#define __lnc__f1668
/// __lnc__f1668()->dynamic
if (live_enabled) {
	return webgl_enabled;
} else return undefined;

#define __lnc__f1669
/// __lnc__f1669()->dynamic
if (live_enabled) {
	return event_data;
} else return undefined;

#define __lnc__f1670
/// __lnc__f1670(...args27:dynamic)->dynamic
if (live_enabled) {
	if(argument[0]){
