#define live_preinit
// Generated at 2018-02-17 19:25:18 (14665ms)
		...
		case 9:
			switch(l_tk0[2]){
				case 0:
					var l_d=l_tk0[1];
					if(this[2]>=this[3]){
						this[@12]=gml_node_global_ref(l_d);
					...
					} else this[@12]=gml_node_global_ref(l_d);
					break;
				case 21:
					if(this[2]>=this[3]){
...
if (live_enabled) {
	...
	switch(l_q[0]){
		...
		case 6:
			...
			l_x=l_q[2];
			switch(l_x[0]){
				case 32:ds_list_add(l_r,gml_action_ensure_array_local(l_d,ds_map_find_value(g_gml_compile_curr_script[5],l_x[2])));break;
				case 35:ds_list_add(l_r,gml_action_ensure_array_global(l_d,l_x[2]));break;
				case 38:
					l_x2=l_x[2];
		...
		case 10:ds_list_add(l_r,gml_action_number(l_q[1],-5));break;
		case 11:ds_list_add(l_r,gml_action_const(l_q[1],gml_std_array_wget(l_q[2],2)));break;
		case 12:ds_list_add(l_r,gml_action_const(l_q[1],l_q[3]));break;
		case 13:ds_list_add(l_r,gml_action_const(l_q[1],g_gml_const_val[?l_q[2]]));break;
		case 14:ds_list_add(l_r,gml_action_arg_const(l_q[1],l_q[2]));break;
		case 15:
			if(gml_compile_node(l_q[2],l_r,true))return true;
			ds_list_add(l_r,gml_action_arg_index(l_q[1]));
			break;
		case 16:ds_list_add(l_r,gml_action_arg_count(l_q[1]));break;
		case 18:
			l_d=l_q[1];
			l_w=l_q[3];
			l_n=array_length_1d(l_w);
		...
		case 31:
			...
			break;
		case 32:ds_list_add(l_r,gml_action_local(l_q[1],ds_map_find_value(g_gml_compile_curr_script[5],l_q[2])));break;
		case 33:
			if(gml_compile_node(l_q[3],l_r,true))return true;
		...
		case 34:
			...
			break;
		case 35:ds_list_add(l_r,gml_action_global(l_q[1],l_q[2]));break;
		case 36:
			if(gml_compile_node(l_q[3],l_r,true))return true;
		...
		case 40:
			...
			break;
		case 41:ds_list_add(l_r,gml_action_env(l_q[1],g_gml_var_refs[?l_q[2]]));break;
		case 42:
			var l_s19=l_q[2];
			if(gml_compile_node(l_q[3],l_r,true))return true;
		...
		case 92:
			...
			for(l_k=l_p0;l_k<l_p2;l_k+=1){
				...
				if(l__g1[0]==63){
					var l_lp=l__g1[2];
					var l_d53=l__g1[1];
					if(l_lp==l_p0)l_r[|l_k]=gml_action_jump(l_d53,l_p2);
				}
			}
			break;
		case 93:
			...
			break;
		case 94:ds_list_add(l_r,gml_action_fork(l_q[1],l_out));break;
		case 95:
			l_d=l_q[1];
			l_p0=ds_list_size(l_r);
			if(gml_compile_node(l_q[2],l_r,true))return true;
		...
		case 96:
			...
			l_p1=ds_list_size(l_r);
			if(gml_compile_node(l_q[3],l_r,true))return true;
			if(l_q[0]==96)ds_list_add(l_r,gml_action_jump_unless(l_d,l_p0)); else ds_list_add(l_r,gml_action_jump_if(l_d,l_p0));
			l_p2=ds_list_size(l_r);
			...
			while(l__g1<array_length_1d(l__g2)){
				...
				if(ds_map_exists(this[2],l_scr[0])){
					if(l_scr[0]==l_main){
						...
						if(l_node[0]==89&&array_length_1d(l_node[2])==0){
							var l_w=this[1];
							var l_i=0;
...
#define gml_node_global_ref
/// gml_node_global_ref(d:GmlNodeData)
var this;
this[1,0]=mt_gml_node;
this[1]=argument[0];
this[0]=10;
...
if (live_enabled) {
	...
	switch(l_q[0]){
		...
		case 32:return true;
		case 35:return true;
		case 38:return gml_node_is_simple(l_q[2]);
		case 53:return gml_node_is_simple(l_q[2])&&gml_node_is_simple(l_q[3]);
...
if (live_enabled) {
	...
	switch(l_p[0]){
		case 89:return true;
		case 90:return l_q!=l_p[2];
		case 92:return l_q!=l_p[2];
		case 95:return l_q!=l_p[2];
		case 96:return l_q!=l_p[3];
		case 97:return l_q!=l_p[3];
		case 98:return l_q!=l_p[2];
		case 99:return l_q!=l_p[3];
		default:return false;
	}
} else return false;
...
if (live_enabled) {
	...
	switch(l_a[0]){
		...
		case 14:return l_b[0]==14&&l_a[2]==l_b[2];
		case 15:return l_b[0]==15&&gml_node_equals(l_a[2],l_b[2]);
		case 16:return true;
		case 17:
			if(l_b[0]==17){
				var l_b_args=l_b[3];
		...
		case 30:return l_b[0]==30&&gml_node_equals(l_a[2],l_b[2]);
		case 31:
			if(l_b[0]==31){
				var l_b_not=l_b[4];
				var l_b_val=l_b[3];
		...
		case 32:return l_b[0]==32&&l_a[2]==l_b[2];
		case 33:
			if(l_b[0]==33){
				var l_b_val1=l_b[3];
		...
		case 35:return l_b[0]==35&&l_a[2]==l_b[2];
		case 36:
			if(l_b[0]==36){
				var l_b_val3=l_b[3];
		...
		case 41:return l_b[0]==41&&l_a[2]==l_b[2];
		case 42:
			if(l_b[0]==42){
				var l_b_val7=l_b[3];
		...
		case 89:return l_b[0]==89&&gml_node_equals_list(l_a[2],l_b[2]);
		case 90:
			var l_a_not1=l_a[4];
			if(l_b[0]==90){
				var l_b_not1=l_b[4];
		...
		case 93:return l_b[0]==93&&gml_node_equals(l_a[2],l_b[2]);
		case 94:return true;
		case 95:
			if(l_b[0]==95){
				var l_b_node=l_b[3];
		...
		case 102:return l_b[0]==102&&gml_node_equals(l_a[2],l_b[2]);
		case 103:return true;
		case 104:return true;
		case 105:return true;
		case 106:return true;
		case 107:return l_b[0]==107&&l_a[2]==l_b[2];
		case 108:
			if(l_b[0]==108){
				var l_b_x40=l_b[3];
		...
		case 111:return l_b[0]==111&&l_a[2]==l_b[2];
		case 112:
			if(l_b[0]==112){
				var l_b_pl=l_b[4];
				var l_b_x43=l_b[3];
...
if (live_enabled) {
	...
	switch(l_q[0]){
		...
		case 11:return gml_node_script(l_d,l_q[2]);
		case 12:return gml_node_native_script(l_q[1],l_q[2],l_q[3]);
		case 13:return gml_node_const(l_d,l_q[2]);
		case 14:return gml_node_arg_const(l_d,l_q[2]);
		case 15:return gml_node_arg_index(l_d,gml_node_clone(l_q[2]));
		...
		case 24:return gml_node_prefix(l_d,gml_node_clone(l_q[2]),l_q[3]);
		case 25:return gml_node_postfix(l_d,gml_node_clone(l_q[2]),l_q[3]);
		case 26:return gml_node_un_op(l_d,gml_node_clone(l_q[2]),l_q[3]);
		case 27:return gml_node_bin_op(l_d,l_q[2],gml_node_clone(l_q[3]),gml_node_clone(l_q[4]));
		case 28:return gml_node_set_op(l_d,l_q[2],gml_node_clone(l_q[3]),gml_node_clone(l_q[4]));
		case 29:return gml_node_to_bool(l_d,gml_node_clone(l_q[2]));
		case 30:return gml_node_from_bool(l_d,gml_node_clone(l_q[2]));
		case 31:return gml_node_in(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),l_q[4]);
		case 32:return gml_node_local(l_d,l_q[2]);
		case 33:return gml_node_local_set(l_d,l_q[2],gml_node_clone(l_q[3]));
		case 34:return gml_node_local_aop(l_d,l_q[2],l_q[3],gml_node_clone(l_q[4]));
		case 35:return gml_node_global(l_d,l_q[2]);
		case 36:return gml_node_global_set(l_d,l_q[2],gml_node_clone(l_q[3]));
		case 37:return gml_node_global_aop(l_d,l_q[2],l_q[3],gml_node_clone(l_q[4]));
		case 38:return gml_node_field(l_d,gml_node_clone(l_q[2]),l_q[3]);
		case 39:return gml_node_field_set(l_d,gml_node_clone(l_q[2]),l_q[3],gml_node_clone(l_q[4]));
		case 40:return gml_node_field_aop(l_d,gml_node_clone(l_q[2]),l_q[3],l_q[4],gml_node_clone(l_q[5]));
		case 41:return gml_node_env(l_d,l_q[2]);
		case 42:return gml_node_env_set(l_d,l_q[2],gml_node_clone(l_q[3]));
		case 43:return gml_node_env_aop(l_d,l_q[2],l_q[3],gml_node_clone(l_q[4]));
		case 44:return gml_node_env_fd(l_d,gml_node_clone(l_q[2]),l_q[3]);
		case 45:return gml_node_env_fd_set(l_d,gml_node_clone(l_q[2]),l_q[3],gml_node_clone(l_q[4]));
		case 46:return gml_node_env_fd_aop(l_d,gml_node_clone(l_q[2]),l_q[3],l_q[4],gml_node_clone(l_q[5]));
		case 47:return gml_node_env1d(l_d,l_q[2],gml_node_clone(l_q[3]));
		case 48:return gml_node_env1d_set(l_d,l_q[2],gml_node_clone(l_q[3]),gml_node_clone(l_q[4]));
		case 49:return gml_node_env1d_aop(l_d,l_q[2],gml_node_clone(l_q[3]),l_q[4],gml_node_clone(l_q[5]));
		case 50:return gml_node_alarm(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]));
		case 51:return gml_node_alarm_set(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]));
		case 52:return gml_node_alarm_aop(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),l_q[4],gml_node_clone(l_q[5]));
		case 53:return gml_node_index(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]));
		case 54:return gml_node_index_set(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]));
		case 55:return gml_node_index_aop(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),l_q[4],gml_node_clone(l_q[5]));
		case 56:return gml_node_index_prefix(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),l_q[4]);
		case 57:return gml_node_index_postfix(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),l_q[4]);
		case 58:return gml_node_index2d(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]));
		case 59:return gml_node_index2d_set(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]),gml_node_clone(l_q[5]));
		case 60:return gml_node_index2d_aop(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]),l_q[5],gml_node_clone(l_q[6]));
		case 61:return gml_node_index2d_prefix(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]),l_q[5]);
		case 62:return gml_node_index2d_postfix(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]),l_q[5]);
		case 63:return gml_node_raw_id(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]));
		case 64:return gml_node_raw_id_set(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]));
		case 65:return gml_node_raw_id_aop(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),l_q[4],gml_node_clone(l_q[5]));
		case 66:return gml_node_raw_id_prefix(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),l_q[4]);
		case 67:return gml_node_raw_id_postfix(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),l_q[4]);
		case 68:return gml_node_raw_id2d(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]));
		case 69:return gml_node_raw_id2d_set(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]),gml_node_clone(l_q[5]));
		case 70:return gml_node_raw_id2d_aop(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]),l_q[5],gml_node_clone(l_q[6]));
		case 71:return gml_node_raw_id2d_prefix(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]),l_q[5]);
		case 72:return gml_node_raw_id2d_postfix(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]),l_q[5]);
		case 73:return gml_node_ds_list(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]));
		case 74:return gml_node_ds_list_set(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]));
		case 75:return gml_node_ds_list_aop(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),l_q[4],gml_node_clone(l_q[5]));
		case 76:return gml_node_ds_list_prefix(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),l_q[4]);
		case 77:return gml_node_ds_list_postfix(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),l_q[4]);
		case 78:return gml_node_ds_map(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]));
		case 79:return gml_node_ds_map_set(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]));
		case 80:return gml_node_ds_map_aop(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),l_q[4],gml_node_clone(l_q[5]));
		case 81:return gml_node_ds_map_prefix(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),l_q[4]);
		case 82:return gml_node_ds_map_postfix(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),l_q[4]);
		case 83:return gml_node_ds_grid(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]));
		case 84:return gml_node_ds_grid_set(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]),gml_node_clone(l_q[5]));
		case 85:return gml_node_ds_grid_aop(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]),l_q[5],gml_node_clone(l_q[6]));
		case 86:return gml_node_ds_grid_prefix(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]),l_q[5]);
		case 87:return gml_node_ds_grid_postfix(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]),l_q[5]);
		case 88:return gml_node_var_decl(l_d,l_q[2],gml_node_clone_opt(l_q[3]));
		case 89:
			l_xw=gml_std_array_clone(l_q[2]);
			l_i=array_length_1d(l_xw);
			while(--l_i>=0){
		...
		case 90:return gml_node_if_then(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone_opt(l_q[4]));
		case 91:return gml_node_ternary(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]));
		case 92:
			var l_m=l_q[3];
		...
		case 93:return gml_node_wait(l_d,gml_node_clone(l_q[2]));
		case 94:return gml_node_fork(l_d);
		case 95:return gml_node_while(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]));
		case 96:return gml_node_do_until(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]));
		case 97:return gml_node_do_while(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]));
		case 98:return gml_node_repeat(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]));
		case 99:return gml_node_for(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]),gml_node_clone(l_q[4]),gml_node_clone(l_q[5]));
		case 100:return gml_node_with(l_d,gml_node_clone(l_q[2]),gml_node_clone(l_q[3]));
		case 101:return gml_node_once(l_d,gml_node_clone(l_q[2]));
		case 102:return gml_node_return(l_d,gml_node_clone(l_q[2]));
		case 103:return gml_node_exit(l_d);
		case 104:return gml_node_break(l_d);
		case 105:return gml_node_continue(l_d);
		case 106:return gml_node_debugger(l_d);
		case 107:return gml_node_comment_line(l_d,l_q[2]);
		case 108:return gml_node_comment_line_pre(l_d,l_q[2],gml_node_clone(l_q[3]));
		case 109:return gml_node_comment_line_post(l_d,gml_node_clone(l_q[2]),l_q[3]);
		case 110:return gml_node_comment_line_sep(l_d,l_q[2],gml_node_clone(l_q[3]));
		case 111:return gml_node_comment_block(l_d,l_q[2]);
		case 112:return gml_node_comment_block_pre(l_d,l_q[2],gml_node_clone(l_q[3]),l_q[4]);
		case 113:return gml_node_comment_block_post(l_d,gml_node_clone(l_q[2]),l_q[3],l_q[4]);
	}
} else return undefined;
...
if (live_enabled) {
	...
	switch(l_q[0]){
		...
		case 15:l_r=script_execute(l_c,l_q[2],undefined);break;
		...
		case 26:l_r=script_execute(l_c,l_q[2],undefined);break;
		case 27:
			switch(l_q[2]){
				case 80:
					var l_b=l_q[4];
			...
			break;
		case 28:l_r=script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined);break;
		case 29:l_r=script_execute(l_c,l_q[2],undefined);break;
		case 30:l_r=script_execute(l_c,l_q[2],undefined);break;
		case 31:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined);break;
		case 32:l_r=false;break;
		case 33:l_r=script_execute(l_c,l_q[3],undefined);break;
		case 34:l_r=script_execute(l_c,l_q[4],undefined);break;
		case 35:l_r=false;break;
		case 36:l_r=script_execute(l_c,l_q[3],undefined);break;
		case 37:l_r=script_execute(l_c,l_q[4],undefined);break;
		case 38:l_r=script_execute(l_c,l_q[2],undefined);break;
		case 39:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[4],undefined);break;
		case 40:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[5],undefined);break;
		case 41:l_r=false;break;
		case 42:l_r=script_execute(l_c,l_q[3],undefined);break;
		case 43:l_r=script_execute(l_c,l_q[4],undefined);break;
		case 44:l_r=script_execute(l_c,l_q[2],undefined);break;
		case 45:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[4],undefined);break;
		case 46:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[5],undefined);break;
		case 47:l_r=script_execute(l_c,l_q[3],undefined);break;
		case 48:l_r=script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined);break;
		case 49:l_r=script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[5],undefined);break;
		case 50:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined);break;
		case 51:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined);break;
		case 52:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[5],undefined);break;
		case 53:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined);break;
		case 54:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined);break;
		case 55:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[5],undefined);break;
		case 56:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined);break;
		case 57:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined);break;
		case 58:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined);break;
		case 59:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined)||script_execute(l_c,l_q[5],undefined);break;
		case 60:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined)||script_execute(l_c,l_q[6],undefined);break;
		...
		case 62:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined);break;
		case 63:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined);break;
		case 64:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined);break;
		case 65:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[5],undefined);break;
		case 66:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined);break;
		case 67:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined);break;
		case 68:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined);break;
		case 69:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined)||script_execute(l_c,l_q[5],undefined);break;
		case 70:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined)||script_execute(l_c,l_q[6],undefined);break;
		...
		case 72:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined);break;
		case 73:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined);break;
		case 74:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined);break;
		case 75:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[5],undefined);break;
		...
		case 78:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined);break;
		case 79:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined);break;
		case 80:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[5],undefined);break;
		case 81:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined);break;
		case 82:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined);break;
		case 83:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined);break;
		case 84:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined)||script_execute(l_c,l_q[5],undefined);break;
		case 85:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined)||script_execute(l_c,l_q[6],undefined);break;
		...
		case 87:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)||script_execute(l_c,l_q[4],undefined);break;
		case 88:
			var l_v=l_q[3];
		...
		case 90:
			...
			break;
		case 91:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined)&&script_execute(l_c,l_q[4],undefined);break;
		case 92:
			if(script_execute(l_c,l_q[2],undefined)){
				l_r=true;
			} else {
			...
			break;
		case 93:l_r=script_execute(l_c,l_q[2],undefined);break;
		...
		case 98:l_r=script_execute(l_c,l_q[2],undefined);break;
		case 99:l_r=script_execute(l_c,l_q[2],undefined)||script_execute(l_c,l_q[3],undefined);break;
		case 100:l_r=script_execute(l_c,l_q[2],undefined);break;
		case 101:l_r=script_execute(l_c,l_q[2],undefined);break;
		case 102:l_r=script_execute(l_c,l_q[2],undefined);break;
		case 103:l_r=false;break;
		case 104:l_r=false;break;
		case 105:l_r=false;break;
		case 106:l_r=false;break;
		case 107:l_r=false;break;
		case 108:l_r=script_execute(l_c,l_q[3],undefined);break;
		case 109:l_r=script_execute(l_c,l_q[2],undefined);break;
		case 110:l_r=script_execute(l_c,l_q[3],undefined);break;
		case 111:l_r=false;break;
		case 112:l_r=script_execute(l_c,l_q[3],undefined);break;
		case 113:l_r=script_execute(l_c,l_q[2],undefined);break;
	}
...
if (live_enabled) {
	...
	switch(l_q[0]){
		...
		case 13:l_r=false;break;
		case 14:l_r=false;break;
		case 15:l_r=script_execute(l_c,l_q[2],l_st);break;
		case 16:l_r=false;break;
		case 17:
		...
		case 26:l_r=script_execute(l_c,l_q[2],l_st);break;
		case 27:l_r=script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 28:l_r=script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 29:l_r=script_execute(l_c,l_q[2],l_st);break;
		case 30:l_r=script_execute(l_c,l_q[2],l_st);break;
		case 31:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st);break;
		case 32:l_r=false;break;
		case 33:l_r=script_execute(l_c,l_q[3],l_st);break;
		case 34:l_r=script_execute(l_c,l_q[4],l_st);break;
		case 35:l_r=false;break;
		case 36:l_r=script_execute(l_c,l_q[3],l_st);break;
		case 37:l_r=script_execute(l_c,l_q[4],l_st);break;
		case 38:l_r=script_execute(l_c,l_q[2],l_st);break;
		case 39:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 40:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[5],l_st);break;
		case 41:l_r=false;break;
		case 42:l_r=script_execute(l_c,l_q[3],l_st);break;
		case 43:l_r=script_execute(l_c,l_q[4],l_st);break;
		case 44:l_r=script_execute(l_c,l_q[2],l_st);break;
		case 45:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 46:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[5],l_st);break;
		case 47:l_r=script_execute(l_c,l_q[3],l_st);break;
		case 48:l_r=script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 49:l_r=script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[5],l_st);break;
		case 50:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st);break;
		case 51:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 52:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[5],l_st);break;
		case 53:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st);break;
		case 54:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 55:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[5],l_st);break;
		case 56:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st);break;
		case 57:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st);break;
		case 58:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 59:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st)||script_execute(l_c,l_q[5],l_st);break;
		case 60:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st)||script_execute(l_c,l_q[6],l_st);break;
		case 61:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 62:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 63:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st);break;
		case 64:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 65:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[5],l_st);break;
		case 66:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st);break;
		case 67:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st);break;
		case 68:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 69:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st)||script_execute(l_c,l_q[5],l_st);break;
		case 70:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st)||script_execute(l_c,l_q[6],l_st);break;
		case 71:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 72:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 73:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st);break;
		case 74:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 75:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[5],l_st);break;
		...
		case 78:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st);break;
		case 79:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 80:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[5],l_st);break;
		case 81:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st);break;
		case 82:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st);break;
		case 83:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 84:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st)||script_execute(l_c,l_q[5],l_st);break;
		case 85:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st)||script_execute(l_c,l_q[6],l_st);break;
		case 86:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 87:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 88:
		...
		case 90:
			...
			break;
		case 91:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st);break;
		case 92:
			var l_o=l_q[4];
			var l_m=l_q[3];
			if(script_execute(l_c,l_q[2],l_st)){
			...
			break;
		case 93:l_r=script_execute(l_c,l_q[2],l_st);break;
		case 94:l_r=false;break;
		...
		case 98:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st);break;
		case 99:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st)||script_execute(l_c,l_q[4],l_st)||script_execute(l_c,l_q[5],l_st);break;
		case 100:l_r=script_execute(l_c,l_q[2],l_st)||script_execute(l_c,l_q[3],l_st);break;
		case 101:l_r=script_execute(l_c,l_q[2],l_st);break;
		case 102:l_r=script_execute(l_c,l_q[2],l_st);break;
		case 103:l_r=false;break;
		case 104:l_r=false;break;
		case 105:l_r=false;break;
		case 106:l_r=false;break;
		case 107:l_r=false;break;
		case 108:l_r=script_execute(l_c,l_q[3],l_st);break;
		case 109:l_r=script_execute(l_c,l_q[2],l_st);break;
		case 110:l_r=script_execute(l_c,l_q[3],l_st);break;
		case 111:l_r=false;break;
		case 112:l_r=script_execute(l_c,l_q[3],l_st);break;
		case 113:l_r=script_execute(l_c,l_q[2],l_st);break;
	}
	if(l_st!=undefined)ds_list_delete(l_st,0);
	return l_r;
} else return false;
...
if (live_enabled) {
	switch(l_node[0]){
		...
		case 12:return l_node[3];
		case 13:return g_gml_const_val[?l_node[2]];
...
/// gml_seek_fields_proc(q:node, st:GmlNodeList)->bool
var l_q=argument[0],l_st=argument[1];
if (live_enabled) {
	if(l_q[0]==38){
		var l_s=l_q[3];
		var l_x=l_q[2];
		var l_d=l_q[1];
		if(l_x[0]==10)gml_std_haxe_enum_tools_set(l_q,gml_node_global(l_d,l_s));
	}
	return gml_node_seek(l_q,l_st,g_gml_program_seek_func);
} else return false;
	...
	if(l_q[0]==7){
		...
		if(l_scr!=undefined&&ds_map_exists(l_scr[8],l_s)){
			...
			if(ds_list_size(l_st)>0){
				var l__g=l_st[|0];
				switch(l__g[0]){
					case 53:if((g_gml_var_flags[?l_s]&2)!=0)gml_std_haxe_enum_tools_set(l_st[|0],gml_node_env1d(l__g[1],l_s,l__g[3])); else return gml_program_error(g_gml_program_seek_inst,"`"+l_s+"` is not an array.",l__g[1]);break;
					case 58:return gml_program_error(g_gml_program_seek_inst,"`"+l_s+"` is not a 2d array.",l__g[1]);
...
if (live_enabled) {
	if(l_q[0]==28){
		...
		switch(l__g[0]){
			case 14:break;
			case 15:break;
			case 32:if(l_o!=-1)gml_std_haxe_enum_tools_set(l_q,gml_node_local_aop(l_d,l__g[2],l_o,l_v)); else gml_std_haxe_enum_tools_set(l_q,gml_node_local_set(l_d,l__g[2],l_v));break;
			case 35:if(l_o!=-1)gml_std_haxe_enum_tools_set(l_q,gml_node_global_aop(l_d,l__g[2],l_o,l_v)); else gml_std_haxe_enum_tools_set(l_q,gml_node_global_set(l_d,l__g[2],l_v));break;
			case 38:if(l_o!=-1)gml_std_haxe_enum_tools_set(l_q,gml_node_field_aop(l_d,l__g[2],l__g[3],l_o,l_v)); else gml_std_haxe_enum_tools_set(l_q,gml_node_field_set(l_d,l__g[2],l__g[3],l_v));break;
			case 41:
				var l_s3=l__g[2];
			...
			case 47:
				...
				break;
			case 50:if(l_o!=-1)gml_std_haxe_enum_tools_set(l_q,gml_node_alarm_aop(l_d,l__g[2],l__g[3],l_o,l_v)); else gml_std_haxe_enum_tools_set(l_q,gml_node_alarm_set(l_d,l__g[2],l__g[3],l_v));break;
			case 53:
				var l_xw=l__g[2];
				var l_xd3=l__g[1];
				switch(l_x[0]){
					case 53:if(l_o!=-1)gml_std_haxe_enum_tools_set(l_q,gml_node_index_aop(l_xd3,l_xw,l_x[3],l_o,l_v)); else gml_std_haxe_enum_tools_set(l_q,gml_node_index_set(l_xd3,l_xw,l_x[3],l_v));break;
					case 58:if(l_o!=-1)gml_std_haxe_enum_tools_set(l_q,gml_node_index2d_aop(l_xd3,l_xw,l_x[3],l_x[4],l_o,l_v)); else gml_std_haxe_enum_tools_set(l_q,gml_node_index2d_set(l_xd3,l_xw,l_x[3],l_x[4],l_v));break;
				}
			...
			case 58:
				...
				var l_xd4=l__g[1];
				switch(l_x[0]){
					case 53:if(l_o!=-1)gml_std_haxe_enum_tools_set(l_q,gml_node_index_aop(l_xd4,l_xw1,l_x[3],l_o,l_v)); else gml_std_haxe_enum_tools_set(l_q,gml_node_index_set(l_xd4,l_xw1,l_x[3],l_v));break;
					case 58:if(l_o!=-1)gml_std_haxe_enum_tools_set(l_q,gml_node_index2d_aop(l_xd4,l_xw1,l_x[3],l_x[4],l_o,l_v)); else gml_std_haxe_enum_tools_set(l_q,gml_node_index2d_set(l_xd4,l_xw1,l_x[3],l_x[4],l_v));break;
				}
				g_gml_seek_set_op_resolve_set_op_safe=false;
				...
				break;
			case 63:if(l_o!=-1)gml_std_haxe_enum_tools_set(l_q,gml_node_raw_id_aop(l_d,l__g[2],l__g[3],l_o,l_v)); else gml_std_haxe_enum_tools_set(l_q,gml_node_raw_id_set(l_d,l__g[2],l__g[3],l_v));break;
			case 68:if(l_o!=-1)gml_std_haxe_enum_tools_set(l_q,gml_node_raw_id2d_aop(l_d,l__g[2],l__g[3],l__g[4],l_o,l_v)); else gml_std_haxe_enum_tools_set(l_q,gml_node_raw_id2d_set(l_d,l__g[2],l__g[3],l__g[4],l_v));break;
			case 73:if(l_o!=-1)gml_std_haxe_enum_tools_set(l_q,gml_node_ds_list_aop(l_d,l__g[2],l__g[3],l_o,l_v)); else gml_std_haxe_enum_tools_set(l_q,gml_node_ds_list_set(l_d,l__g[2],l__g[3],l_v));break;
			case 78:if(l_o!=-1)gml_std_haxe_enum_tools_set(l_q,gml_node_ds_map_aop(l_d,l__g[2],l__g[3],l_o,l_v)); else gml_std_haxe_enum_tools_set(l_q,gml_node_ds_map_set(l_d,l__g[2],l__g[3],l_v));break;
			case 83:if(l_o!=-1)gml_std_haxe_enum_tools_set(l_q,gml_node_ds_grid_aop(l_d,l__g[2],l__g[3],l__g[4],l_o,l_v)); else gml_std_haxe_enum_tools_set(l_q,gml_node_ds_grid_set(l_d,l__g[2],l__g[3],l__g[4],l_v));break;
