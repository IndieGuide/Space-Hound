...
//图像资源
m_sprite_idol = s_order_crazyer_idle;
m_sprite_walk = s_order_crazyer_walk;
m_sprite_attack = s_order_crazyer_attack_weapon;
m_sprite_attack_dash = s_order_crazyer_injured;
m_sprite_injured = s_order_crazyer_injured;
